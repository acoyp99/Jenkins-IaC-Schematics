...
// WINDOWS
                    ...
                    powershell '''
                    $token="eyJraWQiOiIyMDIwMDYyNDE4MzAiLCJhbGciOiJSUzI1NiJ9..44iBDiObDIqlbdOpcMrySTmah-q7t95Nz1Q0BgZF-FqjFk1vyx3HJBjbWW-pUpteG-ttbqmgXPbivlPbxWSWYvhoHPtVeBSztxXMO6JrlKij0UuK6Zgb3f2msu7yqNJcwCipoF3g79qSXDDfQcweW4xvO_78PZ0Eq-TJeJFuVcdiKGRvxcRKe2R9Vv5k8KJ4C6i7fQHO4dsExAT4P0mfIEd0cwk_edHoq6Pq9Y9LleWF0DA9ESDzq4kqV78Bq1Lh9zMv1VFhKRLCjpRbntLLhsHfiJ1uEW2gJcj4S8u7XxeaiY_qrYaJE4JMwIUE-tX9YM8rusPKYopeBoa2GhiMpw"
                    $id=(Invoke-RestMethod -Uri "https://schematics.cloud.ibm.com/v1/workspaces" -Method "Post" -Headers @{"Authorization" = $token} -Body \'{"name":"VPC-Jenkins","type": ["terraform_v0.11"],"location": "us-south","description": "Demo","resource_group": "Default","tags": [],"template_repo": {"url": "https://github.com/acoyp99/Jenkins-Terraform"},"template_data": [{"folder": ".","type": "terraform_v0.11","variablestore": [{"name": "ibmcloud_api_key","value": "HU5KaMf34arRT8c9J8yJqlcK4PiUfT-wMMZfS7ZZ4O_3"}]}]}\').id
                    echo $id
                    echo "WorkSpace Creado!"
                    Start-Sleep -s 10
