...
// WINDOWS
                    ...
                    powershell '''
                    $token="eyJraWQiOiIyMDIwMDYyNDE4MzAiLCJhbGciOiJSUzI1NiJ9..OU6ndSP67W__qExlndpRlG6vgZFl07ODweVt-4IrE9UkE5MyNNf6rJI5nsUyG127eQ5RK4-04RDwAJgpNAKr9namENYnUcXsGJAccC_-X2NWe6WjoY3dJChOw3ecd_3HEaxiKNGElUoFwGJFGqPi4zwXCDZfsTpBarm_GUfaygHSR1wIoZHnoxoWFhW4nYoljYPszDT4sP7EBEXcmF7YhPLtlbrvHXo07_D-k-w8OrDAEGSF236khYDOtUZFNI6mY_-tOqMI5P0Kq-SKcGiqnDpuBjzuqDThF-kKwoAcJcamCcq-8mdaa0TDsIFp0v6Lv08a5KOJIoQEZpGm1tYugw"
                    $id=(Invoke-RestMethod -Uri "https://schematics.cloud.ibm.com/v1/workspaces" -Method "Post" -Headers @{"Authorization" = $token} -Body \'{"name":"VPC-Jenkins","type": ["terraform_v0.12"],"location": "us-east","description": "Demo","resource_group": "Default","tags": [],"template_repo": {"url": "https://github.com/emeloibmco/Schematics-VPC-Tomcat/tree/master/TerraformSchematics"},"template_data": [{"folder": ".","type": "terraform_v0.12","variablestore": [{"name": "ibmcloud_api_key","value": ""},{"name": "ssh_public","value": "ssh-rsa "},{"name": "resource_group","value": "Default"}]}]}\').id
                    echo $id
                    echo "WorkSpace Creado!"
                    Start-Sleep -s 10
